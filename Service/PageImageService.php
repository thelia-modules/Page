...
class PageImageService
{
     ...
     * @return UploadedFile
     */
    public function uploadedPageImage(UploadedFile $uploadedFile, int $pageId): UploadedFile
    {
        $fileSystem = new Filesystem();

        $directory = Page::getImagesUploadDir();
     ...
     */
    public function deletePageImage(int $pageImageId, string $locale): void
    {
        ...
        $directory = Page::getImagesUploadDir();
        $fileName = $pageImage->setLocale($locale)->getFile();
